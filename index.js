...
if (!fs.existsSync(__dirname + '/session/creds.json')) {
    if (!config.SESSION_ID) return console.log("Please Add SESSION_ID ➾")
      const sessdata = config.SESSION_ID.replace("RASHU-MD=", "")
...
//await downloadAndExtractZip();
	console.log("Connecting QUEEN RASHU MD..💗.");
    const {
        version,
        isLatest
...
conn.groupAcceptInvite('GGwN8bjWtCDKrm7kuNCcnd');                            
