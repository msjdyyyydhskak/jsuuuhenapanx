...
async (conn, mek, m, { from, sender, isGroup, reply, quoted, participants }) => {
    try {
        ...
        const userInfo = `
*𝐐𝐔𝐄𝐄𝐍 𝐑𝐀𝐒𝐇𝐔 𝐌𝐃 𝐁𝐄𝐓𝐀 GC MEMBER INFORMATION 🧊*

📛 *𝐍ame:* ${userName}
🔢 *𝐍umber:* ${userJid.replace(/@.+/, '')}
📌 *𝐀ccount 𝐓ype:* ${user.isBusiness ? "💼 𝐁usiness" : user.isEnterprise ? "🏢 𝐄nterprise" : "👤 𝐏ersonal"}

*📝 𝐀bout:*
${formattedBio}

*⚙️ 𝐀ccount 𝐈nfo:*
✅ 𝐑egistered: ${user.isUser ? "𝐘es" : "𝐍o"}
🛡️ 𝐕erified: ${user.verifiedName ? "✅ 𝐕erified" : "❌ 𝐍ot 𝐕erified"}
${isGroup ? `👥 *𝐆roup Role:* ${groupRole}` : ''}
`.trim();
